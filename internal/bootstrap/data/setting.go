...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "star音乐考研", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "### star⭐音乐考研", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://jsd.nn.ci/gh/HaTaXu/logo@main/shaanstar.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://jsd.nn.ci/gh/HaTaXu/logo@main/shaanstar.svg", Type: conf.TypeString, Group: model.STYLE},
